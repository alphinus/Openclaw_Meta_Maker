...
- [x] **T01: Stopping-Condition — scripts/verify-s03.sh schreiben** `est:30m`
...
- [x] **T02: Worf aus Template extrahieren + Execution Agents (Kirk, McCoy)** `est:45m`
...
- [x] **T03: Research/Growth/Automation/Builder Agents (Spock, Riker, Scotty, LaForge)** `est:60m`
...
- [x] **T04: Creator/Analyst/Operator/Strategist Agents (Data, Seven, Sulu, Tuvok)** `est:60m`
...
- [x] **T05: Autonome Agents mit Safeguards (Picard, Q, Borg, Troi, Uhura) + Final Verification** `est:90m`
